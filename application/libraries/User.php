    ...
    public function notify($iduser, $notification = 'new_signup') {
        ...
        switch($notification) {
            case 'welcome':
                ...
                $subject = 'Welcome to NewsVerum';
                $message = '<p>
                                Hello,<br />
                                Добро пожаловать в NewsVerum. We are really excited to see you on board. Hope you will enjoy your time here and enrich our portal with valuable contents.
                            </p>
                            <p>
                                Regards,<br />
                                NewsVerum Team
            ...
            default:
                ...
                $message = '<p>
                                Hello,<br />
                                Thank you for joining the NewsVerum. Please follow <a href="'.base_url('account/activate/'.$current_user->code).'">this link</a> to activate your account.
                            </p>
                            <p>
                                You can copy and paste the URL below if the link does not work:<br />
