	...
	<?php foreach($data['news'] as $news): ?>
		...
		<div class="<?php echo $class; ?> news-item news-item-<?php echo $item_count; ?>">
			...
			<p class="alert alert-warning author-info">
				...
				?>
				<i class="fa fa-fw fa-calendar-o"></i> <?php echo date('d.m.Y h:i', strtotime($news->add_date)); ?>
			</p>
			<div class="news-excerpt">
				<?php echo substr(strip_tags($news->body), 0, $length); ?> ... <a href="<?php echo base_url('news/detail/' . $news->idpost); ?>">читать далее <i class="fa fa-fw fa-external-link"></i></a>
			</div>
		</div>
