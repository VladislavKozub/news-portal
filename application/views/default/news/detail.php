<div class="row">
	<div class="col-md-12">
		...
		<p class="author-info alert alert-warning">
			...
			?>
			<i class="fa fa-fw fa-calendar-o"></i> <?php echo date('d.m.Y h:i', strtotime($data['news']->add_date)); ?>
			<?php
			echo (
		...
		<div class="pdf">
			<i class="fa fa-fw fa-file-pdf-o"></i> <a href="<?php echo base_url('news/pdf/' . $data['news']->idpost); ?>">Скачать PDF</a>
		</div>
		<?php endif; ?>
	</div>
</div>